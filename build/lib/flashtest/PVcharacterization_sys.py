""" The `PVcharacterization_sys` module is a set of system-management functions
for running `Module_aging` notebook on different operating systems.
"""

__all__ = ['add_site_packages_path',
           'DISPLAYS']

# Globals used from GLOBAL: IN_TO_MM
